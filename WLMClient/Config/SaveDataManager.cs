    ...
    class SaveDataManager
    {
        ...
        public static SaveData GetConfiguration()
        {
            try
            {
                ...
                string saveServer = ReadOptional(configNode, "SAVE_SERVER", "");

                return new SaveData(Convert.ToBoolean(Convert.ToInt16(rememberId)), Convert.ToBoolean(Convert.ToInt16(rememberPassword)),
                    Convert.ToBoolean(Convert.ToInt16(autoLogin)), saveID, savePass, saveServer);
            }
            catch
            {
                CreateXMLFile();
        ...
        public static void CreateXMLFile()
        {
            ...
            doc.LoadXml("<?xml version=\"1.0\" encoding=\"ISO - 8859 - 1\"?><config><OPTION_REMEMBER_ID>0</OPTION_REMEMBER_ID><OPTION_REMEMBER_PASSWORD>0</OPTION_REMEMBER_PASSWORD><OPTION_LOGIN_AUTO>0</OPTION_LOGIN_AUTO><SAVE_ID></SAVE_ID><SAVE_PASS></SAVE_PASS><SAVE_SERVER></SAVE_SERVER></config>"); //Your string here
